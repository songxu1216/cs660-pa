...
namespace db {
    ...
    class Join : public Operator {
        ...
        JoinPredicate* p = nullptr;
        DbIterator *child1 = nullptr;
        DbIterator *child2 = nullptr;
        std::optional<Tuple> outerTuple = std::nullopt;
        std::optional<Tuple> innerTuple = std::nullopt;
    protected:
        /**
